...
//内容适应居中
	var size=$(function(){
		$("aside").css({"top":($(".active").height()-$("aside").height())/2});
		$("#home_content").css({"padding-top":($(".active").height()-$("#home_content").height())/5});
		$("#about_content").css({"padding-top":($(".active").height()-$("#about_content").height())/5});
		$("#skill_content").css({"padding-top":($(".active").height()-$("#skill_content").height())/5});
		$("#exp_content").css({"padding-top":($(".active").height()-$("#exp_content").height())/5});
